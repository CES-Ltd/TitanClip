/**
 * `definePlugin` — the top-level helper for authoring a TitanClip plugin.
 *
...
// ---------------------------------------------------------------------------
// TitanClipPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 */
export interface TitanClipPlugin {
 ...
 * @returns A sealed `TitanClipPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@titanclip/plugin-sdk";
 ...
 * @see PLUGIN_SPEC.md §14.1 — Example SDK Shape
 */
export function definePlugin(definition: PluginDefinition): TitanClipPlugin {
