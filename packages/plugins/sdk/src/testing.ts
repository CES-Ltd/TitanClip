...
function requireCapability(manifest: TitanClipPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the TitanClip server runtime.
 */
