 ...
 * channel.
 *
 * The TitanClip plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@titanclip/shared";
 ...
 * we use strings (UUIDs or monotonic counters) for all TitanClip messages.
 */
...
/**
 * TitanClip plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this TitanClip instance. */
    instanceId: string;
    /** Semver version of the running TitanClip host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
