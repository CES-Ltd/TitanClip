/**
 * `@titanclip/plugin-sdk/ui` — TitanClip plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@titanclip/plugin-sdk` (root).
 *
 ...
 * import { usePluginData, usePluginAction } from "@titanclip/plugin-sdk/ui";
 * import type { PluginWidgetProps } from "@titanclip/plugin-sdk/ui";
 *
