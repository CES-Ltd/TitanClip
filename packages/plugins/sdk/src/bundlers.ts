/**
 * Bundling presets for TitanClip plugins.
 *
 ...
 * to match the TitanClip plugin loader contract.
 */
export function createPluginBundlerPresets(input: PluginBundlerPresetInput = {}): PluginBundlerPresets {
  const uiExternal = [
    "@titanclip/plugin-sdk/ui",
    "@titanclip/plugin-sdk/ui/hooks",
    "react",
    "react-dom",
    "react/jsx-runtime",
  ];
