...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within TitanClipPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the TitanClip host.
 *
 ...
 */
export interface TitanClipPluginManifestV1 {
   ...
   */
  minimumTitanClipVersion?: PluginMinimumHostVersion;
