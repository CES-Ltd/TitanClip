# TitanClip API Reference

Detailed reference for the TitanClip control plane API. For the core heartbeat procedure and critical rules, see the main `SKILL.md`.
...
{
  "name": "TitanClip Mobile App",
  "description": "Ship iOS + Android client",
  "status": "planned",
  "goalIds": ["{goalId}"],
  "workspace": {
    "name": "titanclip-mobile",
    "cwd": "/Users/me/titanclip-mobile",
    "repoUrl": "https://github.com/acme/titanclip-mobile",
    "repoRef": "main",
    "isPrimary": true
  }
}
...
Use `titanclip-create-agent` for the full hiring workflow (reflection + config comparison + prompt drafting).
