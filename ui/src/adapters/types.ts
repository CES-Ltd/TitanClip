...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@titanclip/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@titanclip/adapter-utils").TranscriptEntry[];
