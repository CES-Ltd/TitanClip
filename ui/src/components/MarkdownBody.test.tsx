...
import { buildAgentMentionHref, buildProjectMentionHref } from "@titanclip/shared";
...
describe("MarkdownBody", () => {
  ...
  it("renders agent and project mentions as chips", () => {
    const html = renderToStaticMarkup(
      <ThemeProvider>
        <MarkdownBody>
          {`[@CodexCoder](${buildAgentMentionHref("agent-123", "code")}) [@TitanClip App](${buildProjectMentionHref("project-456", "#336699")})`}
        </MarkdownBody>
      </ThemeProvider>,
    );
