...
// Canonical type lives in @titanclip/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@titanclip/adapter-utils";
import type { CreateConfigValues } from "@titanclip/adapter-utils";
...
const ENABLED_ADAPTER_TYPES = new Set(["claude_local", "codex_local", "gemini_local", "opencode_local", "pi_local", "cursor", "hermes_local", "titanclaw_local"]);
  ...
  return (
    <div className="space-y-1.5">
      ...
      <p className="text-[11px] text-muted-foreground/60">
        TITANCLIP_* variables are injected automatically at runtime.
      </p>
    </div>
  );
}
