...
const INSTANCE_SETTINGS_MEMORY_KEY = "titanclip.lastInstanceSettingsPath";
...
export function Layout() {
  ...
  // theme toggle and settings link moved to AppTitleBar
  ...
  return (
    ...
    <GeneralSettingsProvider value={{ keyboardShortcutsEnabled }}>
      ...
      className={cn(
        ...
        isMobile ? "min-h-dvh" : "flex h-full flex-col overflow-hidden",
      )}
      >
      <a
        href="#main-content"
      ...
      <div className={cn("min-h-0 flex-1", isMobile ? "w-full" : "flex overflow-hidden")}>
        ...
        {isMobile ? (
          ...
          >
            ...
            {/* Settings + theme toggle moved to AppTitleBar */}
          </div>
        ) : (
        ...
        <div className={cn("flex min-w-0 flex-col", isMobile ? "w-full" : "h-full flex-1")}>
          ...
          >
            <div className="md:hidden"><BreadcrumbBar /></div>
          </div>
