...
describe("createZipArchive", () => {
  ...
  it("reads a TitanClip zip archive back into rootPath and file contents", async () => {
    const archive = createZipArchive(
      {
        "COMPANY.md": "# Company\n",
        "agents/ceo/AGENTS.md": "# CEO\n",
        ".titanclip.yaml": "schema: paperclip/v1\n",
      },
      "paperclip-demo",
    );
  ...
  it("reads standard DEFLATE zip archives created outside TitanClip", async () => {
