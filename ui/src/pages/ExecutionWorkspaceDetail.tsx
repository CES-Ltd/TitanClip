...
import type { ExecutionWorkspace, Project, ProjectWorkspace } from "@titanclip/shared";
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1.4fr)_minmax(18rem,0.95fr)]">
          <div className="space-y-6">
            <div className="rounded-2xl border border-border bg-card p-5">
              <div className="flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-start sm:justify-between">
                <div className="space-y-2">
                  ...
                  <p className="max-w-2xl text-sm text-muted-foreground">
                    Configure the concrete runtime workspace that TitanClip reuses for this issue flow. These settings stay
              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                <Field label="Provision command" hint="Runs when TitanClip prepares this execution workspace">
                  <textarea
              ...
              <div className="mt-4 grid gap-4">
                ...
                <Field label="Runtime services JSON" hint="Concrete workspace runtime settings for this execution workspace. Leave this inheriting unless you need a one-off override. If you are missing the right commands, ask your Business Unit Head to set them up for you.">
