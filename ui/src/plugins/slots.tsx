 ...
 *
 * Plugin bundles are built with `external: ["@titanclip/plugin-sdk/ui", "react", "react-dom"]`,
 * so their ESM output contains bare specifier imports like:
 *
 * ```js
 * import { usePluginData } from "@titanclip/plugin-sdk/ui";
 ...
 * - `import { ... } from "@titanclip/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@titanclip/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@titanclip/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@titanclip/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@titanclip/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@titanclip/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
