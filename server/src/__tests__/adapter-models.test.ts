...
import { models as codexFallbackModels } from "@titanclip/adapter-codex-local";
import { models as cursorFallbackModels } from "@titanclip/adapter-cursor-local";
import { models as opencodeFallbackModels } from "@titanclip/adapter-opencode-local";
import { resetOpenCodeModelsCacheForTests } from "@titanclip/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.TITANCLIP_OPENCODE_COMMAND;
  ...
  it("returns opencode fallback models including gpt-5.4", async () => {
    process.env.TITANCLIP_OPENCODE_COMMAND = "__paperclip_missing_opencode_command__";
