...
describe("buildInviteOnboardingTextDocument", () => {
  it("renders a plain-text onboarding doc with expected endpoint references", () => {
    ...
    expect(text).toContain("TitanClip OpenClaw Gateway Onboarding");
    ...
    expect(text).toContain("Suggested TitanClip base URLs to try");
    ...
    expect(text).toContain("TITANCLIP_API_KEY");
