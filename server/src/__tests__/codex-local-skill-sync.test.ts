...
describe("codex local skill sync", () => {
  ...
  it("reports configured TitanClip skills for workspace injection on the next run", async () => {
  ...
  it("does not persist TitanClip skills into CODEX_HOME during sync", async () => {
  ...
  it("keeps required bundled TitanClip skills configured even when the desired set is emptied", async () => {
  ...
  it("normalizes legacy flat TitanClip skill refs before reporting configured state", async () => {
