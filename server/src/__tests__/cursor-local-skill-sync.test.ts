...
describe("cursor local skill sync", () => {
  ...
  it("reports configured TitanClip skills and installs them into the Cursor skills home", async () => {
  ...
  it("recognizes company-library runtime skills supplied outside the bundled TitanClip directory", async () => {
  ...
  it("keeps required bundled TitanClip skills installed even when the desired set is emptied", async () => {
