...
import type { agents } from "@titanclip/db";
import { sessionCodec as codexSessionCodec } from "@titanclip/adapter-codex-local/server";
...
describe("parseSessionCompactionPolicy", () => {
  it("disables TitanClip-managed rotation by default for codex and claude local", () => {
