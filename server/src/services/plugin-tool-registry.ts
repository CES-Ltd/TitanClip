...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@titanclip/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: TitanClipPluginManifestV1, pluginDbId?: string): void;
