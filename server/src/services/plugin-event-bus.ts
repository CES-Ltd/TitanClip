/**
 * PluginEventBus — typed in-process event bus for the TitanClip plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@titanclip/shared";
import type { PluginEvent, EventFilter } from "@titanclip/plugin-sdk";
