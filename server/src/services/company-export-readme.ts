 ...
 */
import type { CompanyPortabilityManifest } from "@titanclip/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [TitanClip](https://paperclip.ing)");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [TitanClip](https://paperclip.ing) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [TitanClip](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
